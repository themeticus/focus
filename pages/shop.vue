<template>
  <section>
	...
	<div id="sidebar">
	    ...
	    <div id="basket" class="basket" :data-totalitems="currentCartTotal">
	    ...
	    <div class="product">
	        <div class="make3D">
	            <div class="product-front">
	                ...
	                <div class="add_to_cart addtocart">Add to cart  <span class="cart-items"></span></div>

	                <div class="view_gallery">View gallery</div>                
	                <div class="stats">        	
	                    <div class="stats-container">
	                        <span class="product_price">R399</span>
	                        <span class="product_name">ECRU KNITTED SKIRT</span>    
	                        <p>Calf length</p>                                            
	    ...
	    <div class="product">
	        <div class="make3D">
	            <div class="product-front">
	                ...
	                <div class="stats">         
	                    <div class="stats-container">
	                        <span class="product_price">R259</span>
	                        <span class="product_name">OLA MAMI TEE</span>    
	                        <p>Printed t-shirt</p>                                            
	            ...
	            <div class="product-back">
	                <div class="shadow"></div>
	                <div >
	                    <div class="product_2_2 productSlider" ></div>           
	                </div>
	                <div class="flip-back">
	                    <div class="cy"></div>
	                    <div class="cx"></div>
	    ...
	    <div class="product">
	        <div class="make3D">
	            <div class="product-front">
	                ...
	                <div class="stats">         
	                    <div class="stats-container">
	                        <span class="product_price">R299</span>
	                        <span class="product_name">ECRU KNITTED TOP</span>    
	                        <p>Oversized sleeves</p>                                            
	            ...
	            <div class="product-back">
	                <div class="shadow"></div>
	                <div >
	                    <div class="product_3_2 productSlider" ></div>           
	                </div>
	                <div class="flip-back">
	                    <div class="cy"></div>
	                    <div class="cx"></div>
	        ...
	        <div class="make3D">
	            <div class="product-front">
	                ...
	                <div class="stats">         
	                    <div class="stats-container">
	                        <span class="product_price">R399</span>
	                        <span class="product_name">SLATE KNITTED TOP</span>    
	                        <p>Polo kneck</p>                                            
	            ...
	            <div class="product-back">
	                <div class="shadow"></div>
	                <div >
	                    <div class="product_4_2 productSlider" ></div>           
	                </div>
	                <div class="flip-back">
	                    <div class="cy"></div>
	                    <div class="cx"></div>
	        ...
	        <div class="make3D">
	            <div class="product-front">
	                ...
	                <div class="stats">         
	                    <div class="stats-container">
	                        <span class="product_price">R399</span>
	                        <span class="product_name">BLACK KNITTED TOP</span>    
	                        <p>Polo kneck</p>                                            
	            ...
	            <div class="product-back">
	                <div class="shadow"></div>
	                <div >
	                    <div class="product_5_2 productSlider" ></div>           
	                </div>
	                <div class="flip-back">
	                    <div class="cy"></div>
	                    <div class="cx"></div>
	    ...
	    <div class="product">
	        <div class="make3D">
	            <div class="product-front">
	                ...
	                <div class="stats">         
	                    <div class="stats-container">
	                        <span class="product_price">R799</span>
	                        <span class="product_name">MILK SWEAT SET</span>    
	                        <p>Comfy Tracks</p>                                            
	            ...
	            <div class="product-back">
	                <div class="shadow"></div>
	                <div >
	                    <div class="product_6_2 productSlider" ></div>           
	                </div>
	                <div class="flip-back">
	                    <div class="cy"></div>
	                    <div class="cx"></div>
...
<style scoped>
	...
	* { 
	...
	section h1 {
		...
		div.c-blue span{background:#F3EFE0;}
		div.c-red span{background:#000;}
		div.c-green span{background:#fff;}
		div.c-white span{
			background:#fff;
			width:14px;
			height:14px; 
		...
		.cart-item strong{color:#614107d4; font-size:16px;}
		.cart-item span{
			color: #393c45;
		    display: block;
		    font-size: 14px;
		...
		div.sendtocart .cart-items {
		  display: block;
		  animation: xAxis 1s forwards cubic-bezier(1, 0.44, 0.84, 0.165);
		}
		div.sendtocart .cart-items:before {
	...
	line-height: 22px;
		...
		.product_1_2 {
			background-image: url('~static/images/1-2.jpg');
		}
		...
		.product_3_2 {
			background-image: url('~static/images/3-2.jpg');
		}

		.product_4_2 {
			background-image: url('~static/images/4-2.jpg');
		}

		.product_5_2 {
			background-image: url('~static/images/5-2.jpg');
		}

		.product_6_2 {
			background-image: url('~static/images/6-2.jpg');
		}
		...
		#smenuToggle input:checked~#cart {
		    transform: none;
		}
...
let cart, cartTotal, newCartTotal, button;
